...
public let protocolMinor: UInt32 = 4
...
public enum Handshake {
  public static func swiftEngineHello(
    ...
    let advertisedRuntimeCapabilities = runtimeCapabilities.intersection(
      protocol14RuntimeCapabilities
    )
    hello.optionalCapabilities = (scanCapabilities + Array(advertisedRuntimeCapabilities)).sorted()
