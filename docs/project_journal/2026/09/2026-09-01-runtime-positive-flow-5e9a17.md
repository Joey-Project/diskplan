...
- EngineCore defines immutable preparation context, opaque apply authority, and execution run
  handles without importing DiskplanExecution or exposing raw argv/path mutation authority.
...
- Apply review stores one opaque authority after the exact review projection is delivered. Exact
  confirmation consumes it before backend entry; stale, mismatched, and replayed confirmation
